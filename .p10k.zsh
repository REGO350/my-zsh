# Generated by Powerlevel10k configuration wizard on 2020-12-29 at 17:49 JST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='REGO350@Mac mini'

  ################################[ prompt_char: prompt symbol ]################################
  # Transparent background.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_BACKGROUND=221
